                        ...
                        <tr >
                            ...
                            <td colspan="2" class="nav-bar" >
                                ...
                                <form action="doctors.php" method="post" class="header-search">
                                    ...
                                    <input type="search" name="search" class="input-text header-searchbar" placeholder="Tìm kiếm bác sĩ hoặc email" list="doctors">&nbsp;&nbsp;
                                    ...
                                    <input type="Submit" value="Tìm kiếm" class="login-btn btn-primary-soft btn" style="padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;">
                        ...
                        <table width="100%" border="0" class="dashbord-tables">
                            <tr>
                                <td>
                                    ...
                                    Cuộc hẹn sắp tới cho đến lần tiếp theo <?php  
                                ...
                                <td>
                                    ...
                                    Các phiên sắp tới cho đến Tiếp theo <?php  
                                        echo date("l",strtotime("+1 week"));
                                        ?>
                                    </p>
